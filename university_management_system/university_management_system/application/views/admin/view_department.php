                            ...
                            <tbody>
                                ...
                                foreach ($all_department as $v_result) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            <a class="btn btn-info" href="<?php echo base_url(); ?>edit_category/<?php echo $v_result->dept_id; ?>" title="Edit">
                                                <i class="halflings-icon white edit"></i>Edit  
                                            </a>
                                            <a class="btn btn-danger delete" title="delete this" href="<?php echo base_url(); ?>delete_department/<?php echo $v_result->dept_id; ?>" title="Delete" onclick="return check_delete_info();">
