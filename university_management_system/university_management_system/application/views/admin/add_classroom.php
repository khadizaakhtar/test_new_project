            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    ...
                    <div class="box-content"> 
                        <form class="form-horizontal" action="<?php echo base_url(); ?>save_classroom" method="post">
                            <fieldset>      
                                <div class="control-group">
                                  ...
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="room_number" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4">
                                    </div>
                                </div>
