            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    ...
                    <div class="box-content"> 
                        <form class="form-horizontal" action="<?php echo base_url(); ?>course_assign_to_teacher" method="post" enctype="multipart/form-data">
                            <fieldset>
                                 ...
                                 <div class="control-group">
                                    ...
                                    <div class="controls teacher-info">
                                    </div>
                                </div>
                                ...
                                <div class="credit-to-be-taken-div" id="credit-to-be-taken-div">
                                 ...
                                 <div class="control-group">
                                    ...
                                    <div class="controls course-info">
                                    </div>
                                </div>
                                ...
                                <div class="form-actions">
                                    <button type="submit" name="btn" class="btn btn-primary">Assign</button>
