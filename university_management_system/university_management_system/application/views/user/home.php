...
<html lang="en">
    <head>
        <title>stamford university</title>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
        <meta name="author" content="">
        <meta name="keywords" content="">
        <meta name="description" content="">
        <link rel="icon" type="image/ico" href="user_assets/images/fav.ico">
        <link rel="stylesheet" type="text/css" media="all" href="user_assets/css/bootstrap.min.css">
        <link rel="stylesheet" type="text/css" media="all" href="user_assets/css/camera.css">
        <link rel="stylesheet" type="text/css" media="all" href="user_assets/css/owl.carousel.css">
        <link rel="stylesheet" type="text/css" media="all" href="user_assets/css/owl.transitions.css">
        <link rel="stylesheet" type="text/css" media="all" href="user_assets/css/jquery.custom-scrollbar.css">
        <link rel="stylesheet" type="text/css" media="all" href="user_assets/css/style.css">
        <link href="user_assets/css/font-awesome.min.css" rel="stylesheet">
    </head>
    <body>
        <div class="boxed_layout relative w_xs_auto">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-8 t_align_r t_xs_align_c">
                            <ul class="d_inline_b horizontal_list clearfix t_align_l site_settings">
                                <li class="m_left_5 relative container3d">
                                    <a role="button" href="#" class="button_type_2 color_dark d_block bg_light_color_1 r_corners tr_delay_hover box_s_none" id="currency_button"><span class="d_mxs_none">Contacts</span></a>
                                </li>
                                 <li class="m_left_5 relative container3d">
                                    <a role="button" href="#" class="button_type_2 color_dark d_block bg_light_color_1 r_corners tr_delay_hover box_s_none" id="currency_button"><span class="d_mxs_none">SIGN IN</span></a>
                                </li>
                                <li class="m_left_5 relative container3d">
                                    <a role="button" href="#" class="button_type_2 color_dark d_block bg_light_color_1 r_corners tr_delay_hover box_s_none" id="currency_button"><span class="d_mxs_none">SIGN UP</span></a>
                                </li>
                                <li class="m_left_5 relative container3d" id="shopping_button">
                                    <a role="button" href="#" class="button_type_3 color_light bg_scheme_color d_block r_corners tr_delay_hover box_s_none">Results
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="container clearfix">
                        ...
                        <nav role="navigation" class="f_left f_xs_none d_xs_none">	
                            <ul class="horizontal_list main_menu clearfix">
                                ...
                                <li class="relative f_xs_none m_xs_bottom_5"><a href="index_layout_wide.html" class="tr_delay_hover color_light tt_uppercase"><b>About Us</b></a>
                                </li>
                                <li class="relative f_xs_none m_xs_bottom_5"><a href="category_grid.html" class="tr_delay_hover color_light tt_uppercase"><b>Admission</b></a>
                                </li>
                                <li class="relative f_xs_none m_xs_bottom_5"><a href="#" class="tr_delay_hover color_light tt_uppercase"><b>Academic</b></a>
                                   
                                </li>
                                <li class="relative f_xs_none m_xs_bottom_5"><a href="category_grid.html" class="tr_delay_hover color_light tt_uppercase"><b>Career</b></a>
                                    
                                </li>
                                <li class="relative f_xs_none m_xs_bottom_5"><a href="blog.html" class="tr_delay_hover color_light tt_uppercase"><b>IQAC</b></a>
                                </li>
                                <li class="relative f_xs_none m_xs_bottom_5"><a href="features_shortcodes.html" class="tr_delay_hover color_light tt_uppercase"><b>Library</b></a>
                                  
                                </li>
                                <li class="relative f_xs_none m_xs_bottom_5"><a href="contact.html" class="tr_delay_hover color_light tt_uppercase"><b>Result</b></a></li>
                            </ul>
                        </nav>
            ...
            <div class="camera_wrap m_bottom_0">
                <div data-src="user_assets/images/s1.jpg" data-custom-thumb="user_assets/images/s1.jpg"> 
                </div>
                <div data-src="user_assets/images/s2.jpg" data-custom-thumb="user_assets/images/s2.jpg">  
                </div>
                <div data-src="user_assets/images/s4.jpg" data-custom-thumb="user_assets/images/s4.jpg"> 
                </div>
            </div>
            ...
            <div class="page_content_offset">
                <div class="container">
                    <h2 class="tt_uppercase m_bottom_20 color_dark heading1 animate_ftr">All Teacher</h2>
                    ...
                    <ul class="horizontal_list clearfix tt_uppercase isotope_menu f_size_ex_large">
                        ...
                        <li class="m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><button class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter=".featured">CSE</button></li>
                        <li class="m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><button class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter=".new">CEN</button></li>
                        <li class="m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><button class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter=".specials">ELECTRICAL</button></li>
                        <li class="m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><button class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter=".hit">LLB</button></li>
                        <li class="m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><button class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter=".random">MBA</button></li>
                        <li class="m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><button class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter=".rated">ENGLISH</button></li>
                    </ul>
                    <!--products-->
                    <section class="products_container clearfix m_bottom_25 m_sm_bottom_15">
                        ...
                        <div class="product_item">
                            <figure class="r_corners photoframe shadow relative hit animate_ftb long">
                                ...
                                <a href="#" class="d_block relative pp_wrap">
                                    <!--hot product-->
                                    <span class="hot_stripe"><img src="user_assets/images/hot_product.png" alt=""></span>
                                    <img src="user_assets/images/product_img_1.jpg" class="tr_all_hover" alt="">
                        ...
                        <div class="product_item featured">
                            <figure class="r_corners photoframe shadow relative animate_ftb long">
                                ...
                                <a href="#" class="d_block relative wrapper pp_wrap">
                                    <img src="user_assets/images/product_img_2.jpg" class="tr_all_hover" alt="">
                        ...
                        <div class="product_item new">
                            <figure class="r_corners photoframe shadow relative animate_ftb long">
                                <!--product preview-->
                                <a href="#" class="d_block relative wrapper pp_wrap">
                                    <img src="user_assets/images/product_img_3.jpg" class="tr_all_hover" alt="">
                                    <span data-popup="#quick_view_product" class="box_s_none button_type_5 color_light r_corners tr_all_hover d_xs_none">Quick View</span>
                                </a>
                                <!--description and price of product-->
                                <figcaption>
                        ...
                        <div class="product_item specials">
                            <figure class="r_corners photoframe shadow relative animate_ftb long">
                                ...
                                <a href="#" class="d_block relative pp_wrap">
                                    <!--sale product-->
                                    <span class="hot_stripe"><img src="user_assets/images/sale_product.png" alt=""></span>
                                    <img src="user_assets/images/product_img_4.jpg" class="tr_all_hover" alt="">
                                    <span data-popup="#quick_view_product" class="box_s_none button_type_5 color_light r_corners tr_all_hover d_xs_none">Quick View</span>
                                </a>
                                <!--description and price of product-->
                                <figcaption>
                        ...
                        <div class="product_item hit">
                            <figure class="r_corners photoframe shadow relative animate_ftb long">
                                ...
                                <a href="#" class="d_block relative pp_wrap">
                                    <!--hot product-->
                                    <span class="hot_stripe type_2"><img src="user_assets/images/hot_product_type_2.png" alt=""></span>
                                    <img src="user_assets/images/product_img_5.jpg" class="tr_all_hover" alt="">
                                    <span data-popup="#quick_view_product" class="box_s_none button_type_5 color_light r_corners tr_all_hover d_xs_none">Quick View</span>
                                </a>
                                <!--description and price of product-->
                                <figcaption>
                        ...
                        <div class="product_item featured">
                            <figure class="r_corners photoframe shadow relative animate_ftb long">
                                <!--product preview-->
                                <a href="#" class="d_block relative wrapper pp_wrap">
                                    <img src="user_assets/images/product_img_6.jpg" class="tr_all_hover" alt="">
                                    <span data-popup="#quick_view_product" class="box_s_none button_type_5 color_light r_corners tr_all_hover d_xs_none">Quick View</span>
                        ...
                        <div class="product_item specials">
                            <figure class="r_corners photoframe shadow relative animate_ftb long">
                                <!--product preview-->
                                <a href="#" class="d_block relative wrapper pp_wrap">
                                    <img src="user_assets/images/product_img_7.jpg" class="tr_all_hover" alt="">
                                    <span data-popup="#quick_view_product" class="box_s_none button_type_5 color_light r_corners tr_all_hover d_xs_none">Quick View</span>
                                </a>
                                <!--description and price of product-->
                                <figcaption>
                        ...
                        <div class="product_item rated">
                            <figure class="r_corners photoframe shadow relative animate_ftb long">
                                ...
                                <a href="#" class="d_block relative pp_wrap">
                                    <!--sale product-->
                                    <span class="hot_stripe type_2"><img src="user_assets/images/sale_product_type_2.png" alt=""></span>
                                    <img src="user_assets/images/product_img_8.jpg" class="tr_all_hover" alt="">
                                    <span data-popup="#quick_view_product" class="box_s_none button_type_5 color_light r_corners tr_all_hover d_xs_none">Quick View</span>
                                </a>
                                <!--description and price of product-->
                                <figcaption>
                    ...
                    <section class="row clearfix m_bottom_45 m_sm_bottom_35">
                        <div class="col-lg-6 col-md-6 col-sm-6 animate_half_tc">
                            <a href="#" class="d_block banner wrapper r_corners relative m_xs_bottom_30">
                                <img src="user_assets/images/c1.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 animate_half_tc">
                            <a href="#" class="d_block banner wrapper r_corners type_2 relative">
                                <img src="user_assets/images/c2.jpg" alt="">
                            </a>
                        </div>
                    </section>
                    <!--product brands-->
                    ...
                    <div class="product_brands m_bottom_45 m_sm_bottom_35">
                        <a href="#" class="d_block t_align_c animate_fade"><img src="user_assets/images/brand_logo.jpg" alt=""></a>
                        <a href="#" class="d_block t_align_c animate_fade"><img src="user_assets/images/brand_logo.jpg" alt=""></a>
                        <a href="#" class="d_block t_align_c animate_fade"><img src="user_assets/images/brand_logo.jpg" alt=""></a>
                        <a href="#" class="d_block t_align_c animate_fade"><img src="user_assets/images/brand_logo.jpg" alt=""></a>
                        <a href="#" class="d_block t_align_c animate_fade"><img src="user_assets/images/brand_logo.jpg" alt=""></a>
                            ...
                            <div class="blog_carousel">
                                <div class="clearfix">
                                    ...
                                    <a href="#" class="d_block photoframe relative shadow wrapper r_corners f_left m_right_20 animate_ftt f_mxs_none m_mxs_bottom_10">
                                        <img class="tr_all_long_hover" src="user_assets/images/blog_img_1.jpg" alt="">
                                    </a>
                                    <!--post content-->
                                ...
                                <div class="clearfix">
                                    <!--image-->
                                    <a href="#" class="d_block photoframe relative shadow wrapper r_corners f_left m_right_20 animate_ftt f_mxs_none m_mxs_bottom_10">
                                        <img class="tr_all_long_hover" src="user_assets/images/blog_img_2.jpg" alt="">
                                    </a>
                                    <!--post content-->
                                    <div class="mini_post_content">
                                ...
                                <div class="clearfix">
                                    <!--image-->
                                    <a href="#" class="d_block photoframe relative shadow wrapper r_corners f_left m_right_20 animate_ftt f_mxs_none m_mxs_bottom_10">
                                        <img class="tr_all_long_hover" src="user_assets/images/blog_img_3.jpg" alt="">
                                    </a>
                                    <!--post content-->
                                    <div class="mini_post_content">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 ti_animate animate_ftr">
                            ...
                            <div class="testiomials_carousel">
                                <div>
                                    ...
                                    <img class="circle m_left_20 d_inline_middle animate_ftr" src="user_assets/images/testimonial_img_1.jpg" alt="">
                                ...
                                <div>
                                    ...
                                    <img class="circle m_left_20 d_inline_middle" src="user_assets/images/testimonial_img_2.jpg" alt="">
                                ...
                                <div>
                                    ...
                                    <img class="circle m_left_20 d_inline_middle" src="user_assets/images/testimonial_img_3.jpg" alt="">
                                    <div class="d_inline_middle m_left_15">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <a href="#" class="d_block animate_ftb h_md_auto m_xs_bottom_15 banner_type_2 r_corners red t_align_c tt_uppercase vc_child n_sm_vc_child">
                                <span class="d_inline_middle">
                                    <img class="d_inline_middle m_md_bottom_5" src="user_assets/images/banner_img_3.png" alt="">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <a href="#" class="d_block animate_ftb h_md_auto m_xs_bottom_15 banner_type_2 r_corners green t_align_c tt_uppercase vc_child n_sm_vc_child">
                                <span class="d_inline_middle">
                                    <img class="d_inline_middle m_md_bottom_5" src="user_assets/images/banner_img_4.png" alt="">
                                    <span class="d_inline_middle m_left_10 t_align_l d_md_block t_md_align_c">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <a href="#" class="d_block animate_ftb h_md_auto banner_type_2 r_corners orange t_align_c tt_uppercase vc_child n_sm_vc_child">
                                <span class="d_inline_middle">
                                    <img class="d_inline_middle m_md_bottom_5" src="user_assets/images/banner_img_5.png" alt="">
                                    <span class="d_inline_middle m_left_10 t_align_l d_md_block t_md_align_c">
                ...
                <div class="footer_bottom_part">
                    <div class="container clearfix t_mxs_align_c">
                        ...
                        <ul class="f_right horizontal_list clearfix f_mxs_none d_mxs_inline_b">
                            <li><img src="user_assets/images/payment_img_1.png" alt=""></li>
                            <li class="m_left_5"><img src="user_assets/images/payment_img_2.png" alt=""></li>
                            <li class="m_left_5"><img src="user_assets/images/payment_img_3.png" alt=""></li>
                            <li class="m_left_5"><img src="user_assets/images/payment_img_4.png" alt=""></li>
                            <li class="m_left_5"><img src="user_assets/images/payment_img_5.png" alt=""></li>
                        </ul>
                    </div>
                </div>
            </footer>
                    ...
                    <div class="custom_scrollbar">
                        ...
                        <div class="f_left half_column">
                            <div class="relative d_inline_b m_bottom_10 qv_preview">
                                <span class="hot_stripe"><img src="user_assets/images/sale_product.png" alt=""></span>
                                <img src="user_assets/images/quick_view_img_1.jpg" class="tr_all_hover" alt="">
                            </div>
                            <!--carousel-->
                            <div class="relative qv_carousel_wrap m_bottom_20">
                                ...
                                <ul class="qv_carousel d_inline_middle">
                                    <li data-src="user_assets/images/quick_view_img_1.jpg"><img src="user_assets/images/quick_view_img_4.jpg" alt=""></li>
                                    <li data-src="user_assets/images/quick_view_img_2.jpg"><img src="user_assets/images/quick_view_img_5.jpg" alt=""></li>
                                    <li data-src="user_assets/images/quick_view_img_3.jpg"><img src="user_assets/images/quick_view_img_6.jpg" alt=""></li>
                                    <li data-src="user_assets/images/quick_view_img_1.jpg"><img src="user_assets/images/quick_view_img_4.jpg" alt=""></li>
                                    <li data-src="user_assets/images/quick_view_img_2.jpg"><img src="user_assets/images/quick_view_img_5.jpg" alt=""></li>
                                    <li data-src="user_assets/images/quick_view_img_3.jpg"><img src="user_assets/images/quick_view_img_6.jpg" alt=""></li>
                                </ul>
        ...
        <script src="user_assets/js/jquery-2.1.0.min.js"></script>
        <script src="user_assets/js/jquery-migrate-1.2.1.min.js"></script>
        <script src="user_assets/js/retina.js"></script>
        <script src="user_assets/js/camera.min.js"></script>
        <script src="user_assets/js/jquery.easing.1.3.js"></script>
        <script src="user_assets/js/waypoints.min.js"></script>
        <script src="user_assets/js/jquery.isotope.min.js"></script>
        <script src="user_assets/js/owl.carousel.min.js"></script>
        <script src="user_assets/js/jquery.tweet.min.js"></script>
        <script src="user_assets/js/jquery.custom-scrollbar.js"></script>
